...
type UserRepository interface {
	...
	UserInfo(ctx *context.Context, email string) (error, *domain.User)
	AllUsersInfo(ctx *context.Context) (error, *[]domain.User)
...
func (r *UserRepositoryStruct) RegisterAccount(ctx *context.Context, u *domain.User) error {
	...
	_, err := r.DB.Conn.Exec(r.DB.Ctx, query, u.Name, u.Email, u.Address)
	if err != nil {
...
func (r *UserRepositoryStruct) ReplenishBalance(ctx *context.Context, balance float64, email string) error {
	...
	_, err := r.DB.Conn.Exec(r.DB.Ctx, query, balance, email)
	if err != nil {
...
func (r *UserRepositoryStruct) UserInfo(ctx *context.Context, email string) (error, *domain.User) {
...
func (r *UserRepositoryStruct) AllUsersInfo(ctx *context.Context) (error, *[]domain.User) {
